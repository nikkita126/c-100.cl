...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'kindergarten' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'kindergarten' ),
		'repeat-y'  => __( 'Repeat Vertically', 'kindergarten' ),
		'repeat'    => __( 'Repeat All', 'kindergarten' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'kindergarten' ),
		'top center'    => __( 'Top Center', 'kindergarten' ),
		'top right'     => __( 'Top Right', 'kindergarten' ),
		'center left'   => __( 'Middle Left', 'kindergarten' ),
		'center center' => __( 'Middle Center', 'kindergarten' ),
		'center right'  => __( 'Middle Right', 'kindergarten' ),
		'bottom left'   => __( 'Bottom Left', 'kindergarten' ),
		'bottom center' => __( 'Bottom Center', 'kindergarten' ),
		'bottom right'  => __( 'Bottom Right', 'kindergarten')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'kindergarten' ),
		'fixed'  => __( 'Fixed in Place', 'kindergarten')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'kindergarten' ),
		'italic'      => __( 'Italic', 'kindergarten' ),
		'bold'        => __( 'Bold', 'kindergarten' ),
		'bold italic' => __( 'Bold Italic', 'kindergarten' )
		);
